...
public class ReferenceMaterial extends ParametersModel {
    ...
    public static List<ReferenceMaterial> getDefaultModels() {
        ...
        if (models.size() > 0) {
            defaultReferenceMaterial = models.get(0);
        }
        return models;
    }
    ...
    public void calculateApparentDates() {
        ...
        lambda232 = PhysicalConstantsModel.defaultPhysicalConstantsModel//
                .getDatumByName(Lambdas.lambda232.getName());

        ValueModel lambda235 = new ValueModel();
        lambda235 = PhysicalConstantsModel.defaultPhysicalConstantsModel//
                .getDatumByName(Lambdas.lambda235.getName());
        ValueModel lambda238 = new ValueModel();
        lambda238 = PhysicalConstantsModel.defaultPhysicalConstantsModel//

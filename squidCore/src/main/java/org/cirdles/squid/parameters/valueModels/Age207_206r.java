...
public class Age207_206r extends ValueModel implements
    ...
    // Instance variables
    private transient ValueModel r238_235s;
    private transient ValueModel r207_206r;
    private transient ValueModel age206_238r;
    private transient ValueModel lambda235;
    private transient ValueModel lambda238;
    ...
    public void calculateValue(
        ...
        try {
            setValue(new BigDecimal(calculateDate(//
                    r238_235sDouble, r207_206r.getValue().doubleValue(), xn), new MathContext(15, RoundingMode.HALF_UP)));
        } catch (Exception e) {

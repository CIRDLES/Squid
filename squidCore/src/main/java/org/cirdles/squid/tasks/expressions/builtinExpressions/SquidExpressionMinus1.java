...
public class SquidExpressionMinus1 {
    ...
    static {
        ...
        ExpressionTreeInterface r254_238wSquared = new ExpressionTree("254/238^2", SquidRatiosModel.buildRatioExpression("254/238"), new ConstantNode("2", 2.0), Operation.pow());

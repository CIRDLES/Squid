 ...
 */
public class TaskDesignGeneralBlank extends TaskDesign {

    public TaskDesignGeneralBlank() throws SquidException {
        super();

        this.nominalMasses = new ArrayList<>(Collections.emptyList());
        this.ratioNames = new ArrayList<>(Collections.emptyList());

        this.name = "New empty General (Ratio) task";
        this.taskType = Squid3Constants.TaskTypeEnum.GENERAL;

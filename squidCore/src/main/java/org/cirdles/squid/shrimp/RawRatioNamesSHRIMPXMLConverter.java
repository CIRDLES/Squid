...
public class RawRatioNamesSHRIMPXMLConverter implements Converter {
     ...
     * against <code>RawRatioNamesSHRIMP.class</code>
     ...
     * matches <code>RawRatioNamesSHRIMP</code>'s <code>Class</code>; else
     * <code>false</code>.
     */
    @Override
    public boolean canConvert(Class clazz) {
        return clazz.equals(RawRatioNamesSHRIMP.class);
    }
     ...
     * <code>writer</code>
     *
     * @pre     <code>value</code> is a valid <code>RawRatioNamesSHRIMP</code>, <code>
     ...
     * <code>writer</code>
     * @param value   <code>RawRatioNamesSHRIMP</code> that you wish to write to a
     * file
    ...
    public void marshal(Object value, HierarchicalStreamWriter writer,
        ...
        RawRatioNamesSHRIMP rawRatioNamesSHRIMP = (RawRatioNamesSHRIMP) value;

        writer.startNode("name");
        writer.setValue(rawRatioNamesSHRIMP.getName());
        writer.endNode();
    }

...
public final class SquidUI extends Application {
    ...
    public static final String EXPRESSION_TOOLTIP_CSS_STYLE_SPECS = "-fx-background-color:khaki;-fx-border-width: 1;-fx-border-color: black;-fx-border-radius: 0;-fx-text-fill: black;-fx-effect:none;-fx-font-size:10px;-fx-font-weight:bold;-fx-font-family:'Courier New';";

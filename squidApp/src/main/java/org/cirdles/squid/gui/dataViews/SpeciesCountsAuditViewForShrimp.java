 ...
 */
public class SpeciesCountsAuditViewForShrimp extends AbstractDataView {

    private final List<Double> totalCounts;

    private final List<Double> totalCountsSBM;
    ...
    private int countsRadioButtonChoice;
    ...
    public void preparePanel() {
        ...
        minY = minCount;//StrictMath.min(minCount, peakTukeysMeanAndUnct[0]) - 0.0002;
        maxY = maxCount;//StrictMath.max(maxCount, peakTukeysMeanAndUnct[0]) + 0.0002;
        minYII = minCountII;
        maxYII = maxCountII;
